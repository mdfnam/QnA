...
**Note:** We will also analyse the grammatical case-status (Raf’, Nasb & Jarr) associated with each ending.
...
**Example:** The `مُسْلِم` (masculin) & the `مُسْلِمَة` (feminine) is the base word here & everything beyond that is status marker (combination of haraka placed on last letter followed by two addidtional letter).
...
**Example:** The `مُسْلِم` (masculine) is the base word here & everything beyond that is the status marker (combination comprises a haraka that sits on the last letter followed by two addidtional letter).
...
**Example:** The `مُسْلِم` (masculine) is the base word here also & everything beyond that is status marker (combination comprises a haraka that sits on the last letter followed by two addidtional letter).
